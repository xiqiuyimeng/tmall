        ...
        <table class="confirmPayOrderItemTable">
            ...
            <c:forEach items="${o.orderItems}" var="oi">
                <tr>
                    ...
                    <div class="orderListItemProductOriginalPrice">￥<span class="originalPrice"><fmt:formatNumber type="number" value="${oi.product.originalPrice}" minFractionDigits="2"/></span></span></div>
                            <div class="orderListItemProductPrice">￥<fmt:formatNumber type="number" value="${oi.product.promotePrice}" minFractionDigits="2"/></div>
                            </td>
                    <td>${oi.number }</td>
                    <td><span class="conformPayProductPrice">￥<fmt:formatNumber type="number" value="${o.total}" minFractionDigits="2"/></span></td>
