                ...
                <c:forEach items="${o.orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemProductInfoPartTR" >
                        ...
                        <td  class="orderItemProductInfoPartTD" width="100px">
                            ...
                            <div class="orderListItemProductOriginalPrice">￥<span class="originalPrice"><fmt:formatNumber type="number" value="${oi.product.originalPrice}" minFractionDigits="2"/></span></div>
